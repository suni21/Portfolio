    ...
    <div>
      ...
      <main className='w-full min-h-screen'>
        ...
        <section id='projects'>
          ...
          <div className='grid gap-8 lg:grid-cols-4 w-auto h-auto mt-36 justify-items-center py-6 p-10'>
            {/* card 1 */}
            <div className="block rounded-xl w-72 group max-w-xs mx-auto p-2 bg-violet-950 ring-1 ring-slate-900/5 shadow-lg hover:bg-violet-300 hover:ring-violet-300 transition duration-100 hover:scale-110 text-white">
              <a href="#">

                <img
                  className="rounded-t-lg  w-28 ml-20 py-4"
              ...
              <div className="p-2">
                ...
                <p className="mb-4 w-auto">
                  As our evolving world shifts more towards digital platforms comes awareness regarding just how significant it is to have access to an application devoted wholly towards this impressive teaching.
                </p>
            ...
            {/* Card2 */}
            <div className="block rounded-xl w-72 group max-w-xs mx-auto p-2 bg-violet-950 ring-1 ring-slate-900/5 shadow-lg text-white hover:bg-violet-300 hover:ring-violet-300 transition duration-100 hover:scale-110 ">
              <a href="#">
                <img
                  className="rounded-t-lg  w-28 ml-20 py-4"
                  src="images/bhagwadgita.png" />
            ...
            {/* Card3 */}
            <div className="block rounded-xl w-72 group max-w-xs mx-auto p-2 bg-violet-950 ring-1 ring-slate-900/5 shadow-lg hover:bg-violet-300 text-white hover:ring-violet-300 transition duration-100 hover:scale-110  ">
              <a href="#">
                <img
                  className="rounded-t-lg  w-28 ml-20 py-4"
                  src="images/bhagwadgita.png" />
            ...
            {/* Card4 */}
            <div className="block rounded-xl w-72 group max-w-xs mx-auto p-2 bg-violet-950 ring-1 ring-slate-900/5 shadow-lg hover:bg-violet-300 hover:ring-violet-300 text-white transition duration-100 hover:scale-110  ">
              <a href="#">
                <img
                  className="rounded-t-lg  w-28 ml-20 py-4"
                  src="images/bhagwadgita.png" />
        ...
        <section>
          <div className='text-center sm:text-left mt-48 before:block before:w-48 before:h-3 before:mb-3 before:rounded-md before:mx-auto sm:before:mx-0 before:dark:bg-violet-400'>
